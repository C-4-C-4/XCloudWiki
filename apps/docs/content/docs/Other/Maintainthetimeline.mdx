---
title: 维护日志
description: 详实记录闲云服务器的维护轨迹、版本迭代以及 Wiki 的更新历程与重要里程碑。
outline: deep
publishedAt: 2026-06-14
authors: "CCCC4444，Love_Story"
---

# 📅 维护日志

这里详细记录了闲云社区从初创至今的重要动态，包含 **Wiki 网站的维护日志** 以及 **游戏服务器的更新日志**。
...
<div className="timeline-item wiki current">
<div className="timeline-dot"></div>
<div className="timeline-date">6月28日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge new">✨ 附魔查询系统升级</span>
<p>全新重构「新版附魔书查询系统」！支持附魔冲突一键智能诊断，并在卡片内集成了多等级交互调整以及属性数值、CD 冷却的动态比例估算。</p>
</div>
<div className="update-entry">
<span className="badge new">🛠️ 投影工具上线</span>
<p>正式上线「投影版本转换器」与「像素画投影生成器」，支持本地一键进行跨 V4~V7 的投影格式转换；并支持将任意图片按抖动等多种高级算法在本地直接编码打包出对应的 <code>.litematic</code> 像素画投影文件，100% 本地计算不上传服务器。</p>
</div>
<div className="update-entry">
<span className="badge docs">👥 联合编辑专区</span>
<p>在图鉴顶部新增联合编辑人员专区，并在关于页面与贡献榜中正式新增核心编辑成员“satori1024”。</p>
</div>
<div className="update-entry">
<span className="badge fix">🧹 商户数据清理</span>
<p>下线了商会页面中 Sakura 商店的相关配置及图片资源，保持商会最新动态同步。</p>
</div>
</div>
</div>
...
<div className="timeline-dot"></div>
<div className="timeline-date">5月25日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge new">✨ 页面上线</span>
<p>新增「奇观建筑」展示页面与「小镇」展示页面，进一步丰富了玩家社区的作品展示体系。</p>
</div>
<div className="update-entry">
<span className="badge docs">📖 内容优化</span>
<p>全面优化了「新手指南」的内容结构，并在共创信息与贡献榜中新增贡献成员“星”。</p>
</div>
<div className="update-entry">
<span className="badge fix">🛠️ 问题修复</span>
...
<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">5月23日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge new">📖 图书馆系统上线</span>
...
<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">5月21日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge new">📖 实用计算器上线</span>
<p>新增「实用计算器」专题页面，为玩家提供高效、便捷的本地化辅助计算工具。</p>
</div>
<div className="update-entry">
<span className="badge new">🛠️ 投影工具箱上线</span>
<p>新增「投影工具」专题页面，深度集成三大核心本地化投影辅助模块，包括：投影版本转换器、三视图在线预览以及智能像素画生成器。</p>
</div>
<div className="update-entry">
<span className="badge ui">✨ 拖拽上传支持</span>
<p>全线升级投影工具箱的上传交互设计，现已全面支持文件与图片拖拽本地解析，并带有动态高亮边框和智能类型校验。</p>
</div>
<div className="update-entry">
<span className="badge ui">🖼️ 全站图片预览</span>
<p>引入全站图片点击放大预览功能，支持无损缩放、旋转与平移，大幅优化图片类指南的操作与观感体验。</p>
</div>
<div className="update-entry">
<span className="badge ui">🔍 悬停超链接预览</span>
...
<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">5月14日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge new">✨ 工具上线</span>
<p>「一键换肤工具」正式发布！集成 MineSkin API，支持玩家直接上传皮肤文件并一键生成游戏内指令。</p>
</div>
<div className="update-entry">
<span className="badge new">📊 服务监控上线</span>
<p>新增实时「服务监控」页面，通过调用 UptimeRobot 及 Umami API，实现服务器状态、网站在线率及流量数据的透明化展示。</p>
</div>
<div className="update-entry">
<span className="badge fix">🔍 搜索引擎进化</span>
<p>全站搜索完成深度性能调优：开启全文深层检索及模糊匹配逻辑（Fuzzy Search），支持关键词前缀联想与自动纠错，大幅提升检索效率与容错率。</p>
</div>
<div className="update-entry">
<span className="badge ui">🎨 页面排版优化</span>
<p>对全站多处页面布局进行了深度优化，重点重构了「维护日志」及「指令指南」的视觉排版，增强了信息展示层级。</p>
</div>
<div className="update-entry">
<span className="badge docs">📖 教程完善</span>
...
<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">5月13日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge new">🎉 全新上线</span>
<p>「闲云附魔书查询引擎」正式发布！全站 200+ 种拓展附魔实现毫秒级检索。</p>
</div>
<div className="update-entry">
<span className="badge ui">💅 视觉优化</span>
...
<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">5月8日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge fix">📱 设备适配</span>
<p>修复 iOS 及微信浏览器首页视频背景无法自动播放的问题，引入手势解锁机制。</p>
</div>
<div className="update-entry">
<span className="badge docs">📖 文档重构</span>
...
<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">5月1日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge docs">📚 内容精修</span>
...
### 📅 2025年 1月
{/* 2025年 1月 */}
<div className="timeline-month">2025年 1月</div>

<div className="timeline-container">

<div className="timeline-item wiki">
<div className="timeline-dot"></div>
<div className="timeline-date">1月26日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge special">🏠 闲云 Wiki 诞生</span>
...
<div className="timeline-item game current">
<div className="timeline-dot"></div>
<div className="timeline-date">6月28日</div>
<div className="timeline-content">
...
<h5>✨ WIKI与游戏数据同步</h5>
<ul>
<li><strong>数据校验</strong>：完成全服 200+ 种附魔的最新参数校对，并将数据无缝接入 Wiki 附魔智能查询系统。</li>
</ul>
</div>
</div>
</div>
...
<div className="timeline-dot"></div>
<div className="timeline-date">5月22日</div>
<div className="timeline-content">
<div className="update-group">
<h5>🚀 新增服务器</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月19日</div>
<div className="timeline-content">
<div className="update-group">
<h5>📜 服务器游戏规则修正</h5>
<ul>
...
<div className="update-entry">
<span className="badge special">🎁 更新礼包</span>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月12日</div>
<div className="timeline-content">
<div className="update-group">
<h5>🔥 征讨世界开启</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月9日</div>
<div className="timeline-content">
<div className="update-group">
<h5>✨ 新增内容</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月6日</div>
<div className="timeline-content">
<div className="update-group">
<h5>✨ 功能增强</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月5日</div>
<div className="timeline-content">
<div className="update-group">
<h5>🛠️ 综合修复</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月4日</div>
<div className="timeline-content">
<div className="update-group">
<h5>✨ 新内容</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月3日</div>
<div className="timeline-content">
<div className="update-group">
<h5>✨ 登录与交互</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">5月2日</div>
<div className="timeline-content">
<div className="update-group">
<h5>🛠️ 经济与地标</h5>
<ul>
...
<div className="timeline-item game">
<div className="timeline-dot"></div>
<div className="timeline-date">4月17日</div>
<div className="timeline-content">
<div className="update-entry">
<span className="badge special">🚀 不删档内测</span>
<p>闲云 1.21.11 核心架构搭建完成，正式航行！支持 1.21.8+ 全版本直连。</p>
</div>
</div>
</div>
